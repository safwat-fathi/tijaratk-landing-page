...
export default function TermsAndConditions() {
  return (
    <div className="min-h-screen bg-gray-100 py-10 px-4 sm:px-6 lg:px-8">
      <Head>
        <title>Terms & Conditions - Tijaratk</title>
        <meta name="description" content="Terms and Conditions of Tijaratk" />
      </Head>
      <div className="max-w-3xl mx-auto bg-white p-6 rounded-lg shadow-md">
        ...
        <p className="text-gray-700">
          Welcome to <strong>Tijaratk</strong> ("we," "our," "us"). By using our
        ...
        <p className="text-gray-700">
          All content, trademarks, and services provided by Tijaratk are
        ...
        <p className="text-gray-700">
          <strong>Email:</strong>{" "}
          <a href="mailto:info@tijaratk.com">Email Us</a>
        </p>
        <p className="text-gray-700">
          <strong>Website:</strong>{" "}
          <Link href="https://Tijaratk">Tijaratk</Link>
        </p>
      </div>
    </div>
  );
