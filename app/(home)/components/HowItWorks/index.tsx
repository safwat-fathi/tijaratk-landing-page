export const HowItWorks = () => {
  const steps = [
    ...
    },
    {
      ...
      title: "AI Analysis",
      description:
        "Our AI automatically processes all interactions in real-time",
    },
    {
      number: "4",
      title: "Get Insights",
      description:
        "Access detailed analytics and insights about your products and customers",
    },
  ];
    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold mb-4">How Tijaratk Works</h2>
